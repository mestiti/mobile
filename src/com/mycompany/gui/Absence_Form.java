...
public class Absence_Form extends SideMenuBaseFormSM{
    ...
    private void initGuiBuilderComponents(Resources res) {
        ...
        gui_Label_4_1.setIcon(res.getImage("label_round.png"));
        ...
        gui_Label_4_2.setIcon(res.getImage("label_round.png"));
        ...
        gui_Label_4_3.setIcon(res.getImage("label_round.png"));
