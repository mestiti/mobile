 ...
 * @author Asus
 */
public class ProfileFormSM extends SideMenuBaseFormSM {
    String username1;
    int id1;
    String img1;
    public ProfileFormSM(Resources res,String username, int id,String img) {
        super(BoxLayout.y());
        ...
        addButtonBottom(arrowDown, username, 0xd997f1, true);
